...
QT_MOC_LITERAL(1, 15, 18), // "operationCompleted"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 7), // "success"
QT_MOC_LITERAL(4, 43, 7) // "message"

    },
    "HistoryManager\0operationCompleted\0\0"
    "success\0message"
};
...
void HistoryManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->operationCompleted((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (HistoryManager::*)(bool , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HistoryManager::operationCompleted)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void HistoryManager::operationCompleted(bool _t1, QString _t2)
{
